          ...
          <div className="max-w-2xl mx-auto">
                ...
                <div className="absolute top-full left-0 right-0 mt-2 bg-black/95 backdrop-blur-xl border border-white/20 rounded-xl shadow-2xl overflow-hidden z-50">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-white/60 text-sm">Search and watch YouTube videos together</div>
                    </div>
                  </button>
            ...
            <div className="space-y-4">
              ...
              <div className="relative search-container">
                ...
                {showSuggestions && shareMode === 'youtube' && searchResults.length > 0 && (
            ...
            <div className="mt-8 pt-6 border-t border-white/10">
              ...
              <div className="grid grid-cols-2 gap-3 text-left">
                ...
                <div className="bg-white/5 rounded-lg p-3">
                  <div className="text-white/60 text-xs mb-1">Screen Share</div>
                  <div className="text-white text-sm font-medium">Share your screen</div>
                </div>
              </div>
            </div>
            </>
